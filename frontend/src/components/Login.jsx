...
function Login() {
     ...
     const [, setAuthUser] = useAuth(); // Assuming useAuth is imported from AuthProvider
     ...
     return (
          <div className='min-h-screen flex flex-col items-center justify-center bg-[#1e1e1e] px-4'>
               <div className='max-w-md w-full bg-[#2f2f2f] rounded-2xl p-6 shadow-lg text-white'>
                    ...
                    <button disabled={loading} onClick={handleSignup} className='w-full bg-indigo-600 hover:bg-indigo-500 py-2 rounded-lg font-semibold transition my-3'>{loading ? "Loging In..." : "Login"}</button>
